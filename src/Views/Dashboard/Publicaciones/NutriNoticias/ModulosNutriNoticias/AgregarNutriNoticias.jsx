...
import  imgAgregarNutriNoticia from '../../../../../Components/Assets/Images/Icons/nutrition.png'


const AgregarNutriNoticias = ({ guardarNutriNoticia, mostrarNotificaciones})  => {
  ...
  const handleAdd = async (values) => {
   ...
   await guardarNutriNoticia(formData)
...
AgregarNutriNoticias.propTypes = {
    guardarNutriNoticia: PropTypes.func.isRequired,
    mostrarNotificaciones: PropTypes.func.isRequired
  };
  

export default connect(null, {guardarNutriNoticia, mostrarNotificaciones})(AgregarNutriNoticias);