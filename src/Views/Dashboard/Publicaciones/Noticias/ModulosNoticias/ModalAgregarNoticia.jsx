...
ModalAgregarNoticia.propTypes = {
  guardarNoticia: PropTypes.func.isRequired,
  mostrarNotificaciones: PropTypes.func.isRequired
};

export default connect(null, {guardarNoticia, mostrarNotificaciones})(ModalAgregarNoticia);
